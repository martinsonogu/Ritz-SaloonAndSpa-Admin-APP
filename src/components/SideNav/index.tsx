...
import { BlogIcon, DashboardNavLinkItemIcon, DownArrowIcon, NavLinkList, SaloonAndSpaIcon } from './constants';
...
export const DashboardSideNav = () => {
  ...
  return (
    <div className='h-screen bg-white z-10 w-[300px] pl-[25px] pr-[20px] py-[30px] shadow-[0px_1px_0px_0px_rgba(18_32_59_0.09)]'>
      <div className='mb-20'><MainLogo/></div>
      <NavLinkItem
      ...
      <Dropdown
        ...
        items={[
          ...
          { id: 3, text: 'Update Services', link: PRIVATE_PATHS.UPDATE_SERVICES },
        ]}
      />
      </div>
      ...
      <div className='border-solid border-t border-[#E4E4E7] w-full mt-[20px] pb-[30px]'>
        <Button
          ...
          name={
            <span className=' text-[15px] flex items-center gap-[10px] px-3 text-[#4B0C67]  font-extrabold'>
              <FontAwesomeIcon icon={faArrowRightFromBracket} style={{ color: '#4B0C67' }} />
              Logout
            </span>
          }
        />
